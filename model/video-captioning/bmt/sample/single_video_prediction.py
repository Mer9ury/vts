...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', type = str, help = 'set output json files of captioning', default='./')
    ...
    file_name = args.rgb_features_path.split('/')[-1].split('_')[1]
    if args.output_json is not None:
        file_path = str(args.output_json) + 'test_' + file_name + '_caption.json'
    else:
        file_path = '/nfs/home/ryan0507/ybigta/test_' + file_name + '_caption.json'
    print(file_path)
    print(captions)
